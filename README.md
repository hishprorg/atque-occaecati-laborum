...
<h1 align="center"><img src="logo.png" /> <br><img src="https://github.com/hishprorg/atque-occaecati-laborum/actions/workflows/test.yml/badge.svg"/> <a href="https://snyk.io/test/github/hishprorg/atque-occaecati-laborum?targetFile=package.json"><img src="https://snyk.io/test/github/hishprorg/atque-occaecati-laborum/badge.svg?targetFile=package.json" data-canonical-src="https://snyk.io/test/github/hishprorg/atque-occaecati-laborum?targetFile=package.json" style="max-width:100%;"></a> <a href="https://www.npmjs.com/package/@hishprorg/atque-occaecati-laborum"><img src='https://img.shields.io/npm/dt/@hishprorg/atque-occaecati-laborum'/></a> <br><a href="https://www.codefactor.io/repository/github/jipaix/@hishprorg/atque-occaecati-laborum"><img src="https://www.codefactor.io/repository/github/jipaix/@hishprorg/atque-occaecati-laborum/badge" /></a> <a href="https://codeclimate.com/github/hishprorg/atque-occaecati-laborum/maintainability"><img src="https://img.shields.io/codeclimate/maintainability-percentage/hishprorg/atque-occaecati-laborum" /></a> <a href="https://deepscan.io/dashboard#view=project&tid=8945&pid=11179&bid=163106"><img src="https://deepscan.io/api/teams/8945/projects/11179/branches/163106/badge/grade.svg"/> <a href="https://discord.gg/cSgnkqxMp2"><img src='https://img.shields.io/discord/706018150520717403'/></a></h1>
...
- Check [advanced examples](https://github.com/hishprorg/atque-occaecati-laborum/tree/master/examples) and see what else you can do
...
# Installation
[![NPM](https://nodei.co/npm/@hishprorg/atque-occaecati-laborum.png?compact=true)](https://nodei.co/npm/@hishprorg/atque-occaecati-laborum/)
# API
## Getting started
There's three different way to import/require xdccJS depending on which environment it is running:
### CommonJS
```js
const XDCC = require('@hishprorg/atque-occaecati-laborum')
const xdccJS = new XDCC.default({/*..options..*/})
```
### Modules
```js
import XDCC from '@hishprorg/atque-occaecati-laborum'
const xdccJS = new XDCC.default({/*..options..*/})
```
### TypeScript
```ts
...
## Installation
```bash
npm install @hishprorg/atque-occaecati-laborum -g
```  
## CLI Options
```
